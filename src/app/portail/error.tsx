    ...
    <div className="min-h-[80vh] flex items-center justify-center p-6">
      <div className="glass rounded-2xl p-10 sm:p-14 max-w-lg w-full text-center border border-[var(--glass-border)]">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <button
            onClick={reset}
            className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-cyan text-navy font-semibold hover:bg-cyan/90 hover:shadow-lg hover:shadow-cyan/25 transition-all active:scale-95"
          >
          ...
          <Link
            href="/portail/auth"
            className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl border border-cyan/30 text-cyan font-semibold hover:bg-cyan/5 transition-all active:scale-95"
          >
            Retour au Portail
